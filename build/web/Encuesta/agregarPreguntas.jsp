...
<html lang="es">
    ...
    <body>
        <div class="container ">
            ...
            <div class="card my-3">
                <h5 class="card-header barra-card-enc text-white">Agregar preguntas a la encuesta</h5>
                <div class="card-body">
                    <h5 class="card-title font-titulo-enc"><%=id_encuesta%> <%=nombre%></h5>
                    <p class="card-text">
                    <div class="row">
                                            ...
                                            switch (tipoPreguntaVa) {
                                                case 'Abierta':
                                                    $(".contenedorPreguntas").append(
                                                            "<div class='card mb-3' >" +
                                                            "<h5 class='card-header barra-card-2 text-white'>Agregue los datos necesarios</h5>" +
                                                ...
                                                case 'Opción multiple':
                                                    ...
                                                    $(".contenedorPreguntas").append( "<div class='card mb-3' >" +
                                                            "<h5 class='card-header barra-card-2 text-white'>Agregue los datos necesarios</h5>" +
                                                            "<div class='card-body text-dark'>" +
                                                            "<h5 class='card-title font-subtitulo'>Pregunta no. " + numeroPreguntas + "</h5>" +
                                                            "<input type='hidden' value='" + numeroPreguntas + "' name='formIdPregunta" + numeroPreguntas + "'>" +
