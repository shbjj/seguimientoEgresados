...
<html lang="es">
  ...
  <body>
    <div class="container">
      ...
      <div class="card mt-3">
        <h5 class="card-header font-white barra-card-enc">Agregar usuario</h5>
        <div class="card-body body-card-preg">
          ...
          <form class="row g-3 needs-validation" novalidate action="<%=request.getContextPath()%>/AgregarUsuario" method="POST">
            <div class="col-md-6">
            ...
            <div class="col-12">
                <div class='d-grid gap-2 mb-3'>
                    ...
                    type="submit" 
                    data-bs-toggle="tooltip" data-bs-placement="bottom" title="Salir y guardar usuario" 
                    onclick="return pass()"
