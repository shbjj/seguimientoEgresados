                        ...
                        <div class="row">
                            <div class="col-md-9">
                              <div class="input-group mb-1">
                                <span class="input-group-text bi bi-search" id="inputAlumnosBuscar">Buscar alumno por matricula</span>
                            ...
                            <div class="col-md-3">
                                <div class='d-grid gap-2'>
                                    <button class="btn btn-warning boton bi bi-arrow-left-right"
                                    data-bs-toggle="tooltip"
                                    data-bs-placement="bottom"
        ...
        <script>//Codigo para busqueda
            ...
            const egresados=[
                ...
                { %>
                        {matricula: '<%=egresados[egresado].getMatricula()%>', 
                          ...
                          semestre: '<%=egresados[egresado].getSemestre()%>',
            ...
            const filtrarAlumnos=()=>{
                ...
                for(let alumno of alumnos)
                {
                    ...
                    {
                        resultadoAlumnos.innerHTML+=`<tr ><td class='col-1'>`+matricula+` No.`+numero+`</td>
                        ...
                        <div class="row">
                                        ...
                                        <!--Boton editar-->
                                        <div class="col-lg-2 me-xl-2">
                                            <a href="<%=request.getContextPath()%>/EditarAlumno?matricula=`+matricula+`"
            ...
            const filtrarEgresados=()=>{
                ...
                for(let egresado of egresados)
                {
                    ...
                    semestre=egresado.semestre;
                    grupo=egresado.grupo;
                    numero=egresado.numero;
                    if(matricula.indexOf(texto)!==-1)
                    {
                        resultadoEgresados.innerHTML+=`<tr ><td class='col-1'>`+matricula+` No.`+numero+`</td>
                        <td class='col-6'>`+nombre+`</td>
                        <td class='col-1 text-center'>`+semestre+`</td>
                        <td class='col-1 text-center'>`+grupo+`</td>
                        <td class='col-2'>
